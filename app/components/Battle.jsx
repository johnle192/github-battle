      ...
      <main className='stack main-stack animate-in'>
        ...
        <section className='grid'>
          {playerOne === null ? 
            ...
            /> : <PlayerPreview label="Player One" username={playerOne} onReset={() => this.handleReset("playerOne")} />}
          {playerTwo === null ? 
            <PlayerInput 
              label="Player Two" 
              onSubmit={(player) => this.handleSubmit("playerTwo", player)} 
            /> : <PlayerPreview label="Player Two" username={playerTwo} onReset={() => this.handleReset("playerTwo")} />}
        </section>
        <Instructions />
      </main>
    )
